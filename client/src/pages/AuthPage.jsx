      ...
      <section className="auth-shell">
        ...
        <form className="auth-card" onSubmit={handleSubmit}>
          <div className="segmented-control">
            <button className={mode === 'signup' ? 'segmented active' : 'segmented'} type="button" onClick={() => handleModeChange('signup')}>
              Sign up
            </button>
            <button className={mode === 'login' ? 'segmented active' : 'segmented'} type="button" onClick={() => handleModeChange('login')}>
              Login
            </button>
          </div>
