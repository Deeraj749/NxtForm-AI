...
// Configure DNS resolver to use public DNS servers to resolve MongoDB SRV records reliably
try {
  dns.setServers(['8.8.8.8', '1.1.1.1'])
} catch (e) {
  console.warn('Failed to set DNS servers, using system defaults:', e.message)
}
